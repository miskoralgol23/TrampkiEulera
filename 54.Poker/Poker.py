...
#
# for x in range(100):
#     print(x, hand_no(x), hand_no(x,2), has_player1_higher_value(x))
#     if sum(hand_value(hand_no(x))) > sum(hand_value(hand_no(x, 2))) and not has_player1_higher_value(x):
